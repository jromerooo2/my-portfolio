...
export default defineComponent({
    ...
    setup() {
        const works = ref<work[]>([
            ...
            { 
                title: 'Sacculum',role:"Software Developer and Researcher", description: `Sacculum is a web and desktop tool desgined to help automate hiring process and maximize opportunities to people that are looking for jobs. Available for free and with 10+ corporations that integrated the tool into their workflow. This project helped me and my teammates to win 2nd place in National Computer Science hackathon. I served as a software developer and researcher to maximize the productivity on hiring teams.`,image:'https://raw.githubusercontent.com/jromerooo2/my-portfolio/master/src/assets/sac.png',color:"text-5xl font-bold text-green-500 text-left", id:"2",link:""
            },
                        
                                    {
                title: 'Locus',role:"Software Developer and Researcher", description: 'Locus is a real time location platform, designed to provide security to public transportation in El Salvador. Where I served as software developer and engineered the Webflow and communications with RTC protocols and sockets. This project helped me and my team to win the 3rd place in a national hackaton.', image:'https://raw.githubusercontent.com/jromerooo2/my-portfolio/master/src/assets/ls.png',color:"text-5xl font-bold text-purple-500 text-left", id:"3",link:"https://github.com/jromerooo2/real-time-l18n"
            },
        ])
