<template>
    <div class="flex justify-evenly space-x-5 p-5">   
        ...
        <div class="flex items-center justify-center group cursor-pointer space-x-5">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-brand-twitter hover:text-blue-500" width="34" height="34" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
