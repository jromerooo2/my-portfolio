...
export default defineComponent({
    ...
    setup() {
        const works = ref<work[]>([
            ...
            { 
                title: 'Sacculum',role:"Software Developer and Researcher", description: `Sacculum is a web and desktop tool to help automate hiring process and maximize opportunities to people that are looking for jobs. Available for free and with 10+ corporations that intagrated them in their workflow. This project helped me and my teammates to win 2nd place in National Computer Sciene hackathon. I served as a software developer and researcher to maximize the productivity on hiring teams.`,image:'https://raw.githubusercontent.com/jromerooo2/my-portfolio/master/src/assets/sac.png',color:"text-5xl font-bold text-green-500 text-left", id:"2",link:""
            },
